...
number_of_metrics );
    ...
    else if ( event_name == "TaskCreate" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfTaskCreateEvent( estimator );
    }
    else if ( event_name == "TaskDestroy" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfTaskDestroyEvent( estimator );
    }
    else if ( event_name == "TaskRunnable" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfTaskRunnableEvent( estimator );
    }
    else if ( event_name == "AddDependence" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfAddDependenceEvent( estimator );
    }
    else if ( event_name == "SatisfyDependence" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfSatisfyDependenceEvent( estimator );
    }
    else if ( event_name == "DataAcquire" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfDataAcquireEvent( estimator );
    }
    else if ( event_name == "DataRelease" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfDataReleaseEvent( estimator );
    }
    else if ( event_name == "EventCreate" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfEventCreateEvent( estimator );
    }
    else if ( event_name == "EventDestroy" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfEventDestroyEvent( estimator );
    }
    else if ( event_name == "DataCreate" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfDataCreateEvent( estimator );
    }
    else if ( event_name == "DataDestroy" )
    {

        size = OTF2_EventSizeEstimator_GetSizeOfDataDestroyEvent( estimator );
    }
    else
    {
