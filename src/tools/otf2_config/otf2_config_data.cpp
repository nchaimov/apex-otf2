...
otf2_config_data::la_object::la_object( void )
{
}

otf2_config_data::la_object::la_object( const la_object& source ) :
...
otf2_config_data::la_object::la_object( const string&        lib_name,
...
otf2_config_data::la_object::~la_object()
{
}
