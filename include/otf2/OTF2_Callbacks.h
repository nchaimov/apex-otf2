 ...
 *
 *  To operate multiple OTF2_Archive objects in a collective context, the
 *  following callbacks need to be implemented. These are mandatory, when
 *  writing a trace file with multiple OTF2_Archive objects. For reading a
 *  set of serial callbacks are provided (See
