...
enum OTF2_RegionRole_enum
{
    ...
    /** @brief Event (pure dependency)
     *  
     *  @since Version 2.0.
     */
    OTF2_REGION_ROLE_EVENT = 38,
    /** @brief Datablock
     *  
     *  @since Version 2.0.
     */
    OTF2_REGION_ROLE_DATABLOCK = 39
};
...
enum OTF2_GroupType_enum
{
     ...
     *  (i.e., MPI_COMM_SELF and friends). At most one of this
     *  definition is allowed to exists per paradigm.
     */
...
enum OTF2_GroupFlag_enum
{
     ...
     *  the ranks are indexes into the the
     *  @eref{OTF2_GROUP_TYPE_COMM_LOCATIONS} group.
     */
